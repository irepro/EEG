...
class Resnet50Encoder(nn.Module):
    def __init__(self, inchannels = 12, n_classes=22):
        ...
        self.layer4 = nn.Sequential(
            ResidualBlock(128, 196, 196),
            ResidualBlock(196, 196, 196, downsample=True),
            ResidualBlock(196, 224, 224),
            ResidualBlock(224, 224, 224, downsample=True) # Code overlaps with previous assignments
        )
        ...
        self.fullconnect = nn.Linear(448,2)
        # Dropout
